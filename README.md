# Jobsprint AI Automation Platform
...
[![Documentation](https://img.shields.io/badge/docs-latest-blue)](https://docs.jobsprint.io)

**Zero-Touch, Full-Stack AI Automation Platform**

Combining Puter.js, Zapier MCP, and n8n for powerful workflow automation without backend code.
...
Jobsprint is a comprehensive AI-powered automation platform that enables anyone to build powerful, intelligent workflows without writing backend code, managing API keys, or setting up infrastructure.

### What Makes Jobsprint Different?

- **Zero Backend Required**: Everything runs in the browser or edge with Puter.js
- **Free AI Models**: Access to GPT-3.5-turbo, Code-Davinci, and Text-Davinci without API keys
- **30,000+ Integrations**: Pre-authenticated connections via Zapier MCP
- **Self-Hosted**: Full control with Docker Compose deployment
- **Beautiful UX**: Gum-based terminal interface for system management
- **Production Ready**: Enterprise-grade architecture with monitoring and scaling

## ✨ Key Features

### 🤖 AI-Powered Automation
- **Free AI Models**: GPT-3.5-turbo-free, Code-Davinci-free, Text-Davinci-free-002
- **Smart Workflows**: AI-powered decision making and content generation
- **Code Generation**: Automated code creation and refactoring
- **Voice Processing**: Speech-to-text with Whisper-free model

### 🔗 Extensive Integrations
- **Zapier MCP**: 30,000+ pre-authified app connections
- **n8n Engine**: Visual workflow builder with 200+ nodes
- **Custom Nodes**: Build your own workflow nodes
- **Webhooks**: Real-time event notifications

### 🎨 Beautiful Interfaces
- **Web UI**: Modern, responsive dashboard
- **Visual Workflow Builder**: Drag-and-drop workflow creation
- **Gum TUI**: Beautiful terminal interface for management
...
- **RabbitMQ**: Robust message brokering
