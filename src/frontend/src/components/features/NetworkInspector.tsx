...
import { FileJson, Search, ArrowRightLeft, Code, Database, Globe } from 'lucide-react';
              ...
              <div className="flex flex-col divide-y">
                {filteredEntries.map((entry, i) => (
                  ...
                  >
                    <Badge
                      variant="outline"
                      className={`mt-0.5 rounded-sm px-1.5 py-0 text-[10px] font-bold uppercase ${getMethodColor(entry.request.method)}`}
                    >
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`font-mono font-bold ${getStatusColor(selectedEntry.response.status)}`}
                    >
                        ...
                        <div>
                          ...
                          <div className="grid gap-1">
                            {selectedEntry.request.headers.map((h: any, i: number) => (
                              <div
                                key={i}
                                className="grid grid-cols-[1fr_2fr] gap-2 text-xs font-mono border-b border-border/50 py-1 last:border-0"
                              >
